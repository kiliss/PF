...
export default function Food(props) {
    ...
    const handleInputChange = function (e) {
        ...
        setError(validate({
          ...comida,
          [e.target.name]: e.target.value,
        }, findedName, "validate", "validate3", nombre));
    };
    
    const handleClick = function (e, id, name, price, summary, name2, price2, summary2) {
        e.preventDefault();
        swal({
                                ...
                                <div className="relative flex w-full items-center overflow-hidden bg-white px-4 pt-14 pb-8 shadow-2xl sm:px-6 sm:pt-8 md:p-6 lg:p-8">
                                    ...
                                    <div className="grid w-full grid-cols-1 items-start gap-y-8 gap-x-6 sm:grid-cols-12 lg:gap-x-8">
                                        <div className="min-h-80 aspect-w-1 aspect-h-1 w-full overflow-hidden rounded-lg bg-gray-100 sm:col-span-4 lg:col-span-5 lg:h-80">
                                            <img src={food?.photo} alt={comida?.name} className="h-full w-full object-cover object-center lg:h-full lg:w-full" />
                                        </div>
                                        <div className="sm:col-span-8 lg:col-span-7">
                                            ...
                                            <section aria-labelledby="options-heading" className="mt-8">
                                                ...
                                                <form>
                                                    ...
                                                    <button type='submit' onClick={(e) => handleClick(e, food?.id, food?.name, food?.price, food?.summary, comida.name, comida.price, comida.description)} className="rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 mt-2">Save</button>
                                            </section>
                                        </div>
                                    </div>
