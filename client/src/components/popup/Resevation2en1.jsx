    ...
    <div className="w-full max-w-4xl mt-20">
        <form onSubmit={handleSubmit} className="flex flex-col items-center bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <h3 className="text-center my-2">${input.price}</h3>
                ...
                <button className="bg-green-500 enabled:hover:bg-green-700 text-white font-bold w-32 py-2 px-4 border border-blue-700 rounded mx-10" disabled={!stripe || !input.id_Table || !input.guest}>
                    {loading ? (
                        <span>...</span>
                    ): (
                        "Reservar"
